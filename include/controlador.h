...
class Controlador{
  public:
    ...
    void procesarToqueVentanaInicio(TSPoint point);
    ...
    void procesarToqueLimpieza(TSPoint point);

    char lugarDondeTocoVentanaInicio(TSPoint point);
    ...
    char lugarDondeTocoLimpieza(TSPoint point);
